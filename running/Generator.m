...
%         subplot(1,3,1)
%         H5Flash(RightLegJointValue, LeftLegJointValue, thighLength, legLength, totalLeglength, index, timeAll, stepLength,startStepLength, stepTime, flyTime,...
%             cycleTime, crouchTime, swingLength, startSwingLength, liftLegLength, crouchLength, hipDistance, LeftPitchAngle, LeftFlagValue, RightPitchAngle, RightFlagValue,xComValueTemp,yComValueTemp,zComValueTemp);
%         view(90,0);
...
%         title('Humanoid Robot Running Flash')
        H5Flash(RightLegJointValue, LeftLegJointValue, thighLength, legLength, totalLeglength, index, timeAll, stepLength,startStepLength, stepTime, flyTime,...
            cycleTime, crouchTime, swingLength, startSwingLength, liftLegLength, crouchLength, hipDistance, LeftPitchAngle, LeftFlagValue, RightPitchAngle, RightFlagValue,xComValueTemp,yComValueTemp,zComValueTemp,RightHand1Value,RightHand2Value,RightHand3Value,LeftHand1Value,LeftHand2Value,LeftHand3Value);
