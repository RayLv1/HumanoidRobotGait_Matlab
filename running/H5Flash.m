function H5Flash(RightLegJointValue,...
   ...
   %% plot ground
    posse = [   -400   -450 + yComValue    -totalLeglength - 10;
                 400   -450 + yComValue    -totalLeglength - 10;
                 400    450 + yComValue    -totalLeglength - 10;
                -400    450 + yComValue    -totalLeglength - 10;
                -400   -450 + yComValue    -totalLeglength - 10;];
         plot3(posse(:,1),posse(:,2),posse(:,3),'-o','LineWidth',3,'MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',5);
         hold on
